...
function marcarElementoSelecionado(evento) {
    ...
    // Se o bloco clicado nao possui a classe 'elemento', consideramos que nao
    // ha um clique valido e encerramos a funcao, retornando algo vazio.
...
function calcularDano() {
    ...
    if (danoTotal >= vidaPersonagem) {
        resultado += 'Parabens, voce matou ' + personagemSelecionado;
    } else {
        resultado += 'Putz, nao foi dessa vez, tente novamente!';
    }
